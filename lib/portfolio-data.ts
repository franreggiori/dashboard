export const AÑOS = [2021, 2022, 2023, 2024, 2025] as const;
export type Año = typeof AÑOS[number];

export const RETORNOS: Record<string, Record<Año, number>> = {
  "SPY":                                 { 2021: 28.73,  2022: -18.18, 2023: 26.17,  2024: 24.89,  2025: 17.72  },
  "QQQ":                                 { 2021: 27.42,  2022: -32.58, 2023: 54.85,  2024: 25.58,  2025: 20.77  },
  "EEM (ETF Emerging Markets)":          { 2021: -4.59,  2022: -20.09, 2023: 7.02,   2024: 7.96,   2025: 11.20  },
  "Neuberguer Global Equity MEGATRENDS": { 2021: 14.80,  2022: -24.20, 2023: 23.50,  2024: 17.80,  2025: 4.50   },
  "GAINVEST RENTA FIJA DOLAR":           { 2021: 5.70,   2022: 5.70,   2023: 5.70,   2024: 5.70,   2025: 5.70   },
  "OBLIGACIONES NEGOCIABLES":            { 2021: 6.00,   2022: 6.00,   2023: 6.00,   2024: 6.00,   2025: 6.00   },
  "PIMCO INCOME FUND":                   { 2021: 1.80,   2022: -3.20,  2023: 7.10,   2024: 6.50,   2025: 5.80   },
